...
trading_trades_collection = db["trading_trades"]   # admin monitoring uses this
...
async def create_indexes():
    ...
    await trading_trades_collection.create_index("user_id")
    await trading_trades_collection.create_index("timestamp")